...
public class GooglePlayTest
{
    ...
    public void TestApartado01()
    {
        ...
        Producto aplicaci1 = new Aplicacion("Spotify", 18.5F, Categoria.MULTIMEDIA);
        Producto aplicaci2 = new Aplicacion("WhatsApp", 22.32F, Categoria.COMUNICACIONES);
        Producto aplicaci3 = new Aplicacion("Pokemon GO", 32.5F, Categoria.JUEGOS);        
    ...
    public void TestApartado02()
    {
        ...
        Producto aplicaci2 = new Aplicacion("WhatsApp", 22.32F, Categoria.COMUNICACIONES);
        Producto aplicaci3 = new Aplicacion("Pokemon GO", 32.5F, Categoria.JUEGOS); 
        Producto aplicaci4 = new Aplicacion("Gmail", 32.5F, Categoria.PRODUCTIVIDAD);        
        Producto libro1 = new Libro("No culpes al karma", 2014, 329, true);
        Producto libro2 = new Libro("La chica del tren", 2015, 625, true);
        Producto libro3 = new Libro("El poder del ahora", 2011, 154, false);        
        Producto pelicula1 = new Pelicula("El renacido", 2015, 156, 1080);
